...
const LandingContent = () => (
  <div className="relative flex-10 flex flex-col items-center md:items-start mt-[-40px] md:mt-[-130px]">
    <div className="px-6 py-6 md:px-0 md:py-0  w-full max-w-2xl">
      <div className="mb-2 flex items-center justify-center md:justify-start">
         ...
         Hey I’m Coffee 
      <span>
  <img src="/coffee.png" alt="coffee" width="60" height="60" />
</span>

        </h2>
      </div>
      <div className="mb-0">
        <span className={`px-[9px] py-0  font-extrabold  text-2xl md:text-[52px]  ${judson.className}`}
        style={{
      ...
      <p className={`mb-10 text-base md:text-[21px] font-medium  tracking-tight ${geist.className}`}
      style={
                {color: "var(--landing-content-intro)"}
               }>
      ...
      <span className='text-[26px]'> Hire Me </span> 
        <span>
